                ...
                <article className='text-start my-5'>
                    <Row className='pt-5 px-3 fs-5'>
                        ...
                        <Col md={6} className='my-auto' data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="1000" data-aos-offset="0">
                            {
                                i18n.language === 'es'
                                    ? <video className='w-100' controls src='/Ecomondo_2024_ES.mp4' poster='/ecomondo/posterVideoEco2023.webp'  />
                                    : <video className='w-100' controls src='/Ecomondo_2024_EN.mp4' poster='/ecomondo/posterVideoEco2023.webp'  />
