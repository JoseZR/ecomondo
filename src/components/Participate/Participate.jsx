    ...
    return (
        ...
        <>
            <Container className='my-5'>
                <h2 className='fw-font title-conferencias'><strong>{t('participate.title')}</strong></h2><br /><br />
                <Row>
                    <Col xs={12} md={4} className='h-100 p-3'>
                        <div className='container-plant'>
                            <h4 className='py-2'>{t('participate.free')}</h4>
                            <p>18m² {t('participate.item01')}</p><p>USD 320 / m² + IVA</p>
                    ...
                    <div className='container-plant'>
                            ...
                            <p>9m² {t('participate.item01')}</p><p>USD 370  / m² + IVA</p>
                                <Row className="justify-content-md-center">
                                    <Col className='m-3'><img src="./alfombra_gris.webp" alt="" className='icon-price'/><br />{t('participate.item05')}</Col>
                                    <Col className='m-3'><img src="./mamparas_gris.webp" alt="" className='icon-price'/><br />{t('participate.item06')}</Col>
                                </Row>
                                <Row className="justify-content-md-center">
                                    <Col className='m-3'><img src="./antepecho_gris.webp" alt="" className='icon-price'/><br />{t('participate.item07')}</Col>
                                    <Col className='m-3'><img src="./iluminacion_gris.webp" alt="" className='icon-price'/><br />{t('participate.item08')}</Col>
                                </Row>
                                <Row className="justify-content-md-center">
                    ...
                    <div className='container-plant'>
                            ...
                            <p>2m² {t('participate.item01')}</p><p>USD 2,200 / m² + IVA</p>
                                <Row className="justify-content-md-center">
                                    <Col className='m-3'><img src="./alfombra_gris.webp" alt="" className='icon-price'/><br />{t('participate.item05')}</Col>
                                    <Col className='m-3'><img src="./mamparas_gris.webp" alt="" className='icon-price'/><br />{t('participate.item06')}</Col>
                                </Row>
                                ...
                                <Row className="justify-content-md-center">
                                    <Col className='m-3'><img src="./contacto_gris.webp" alt="" className='icon-price'/><br />{t('participate.item10')}</Col>
                                    <Col className='m-3'><img src="./badge.webp" alt="" className='icon-price'/><br />{t('participate.item12')}</Col>
                                </Row>
                                <Row className="justify-content-md-center">
                                    <Col className='m-3'><img src="./phone-book.webp" alt="" className='icon-price'/><br />{t('participate.item03')}</Col>
                                </Row><br />
