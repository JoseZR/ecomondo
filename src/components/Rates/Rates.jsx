          ...
          <Col key={index}>
            <Card className='card-padre'>
              <Card.Body className='p-4'>
                <Card.Title className='fs-3 fw-bold text-center pb-3'>
                ...
                <Card.Text className='text-start'>
                  {/* <p className='fs-5 pb-3'>
                    ...
                    {i18n.language === 'en'
                      ...
                      : preEco.early_price_title.es}{' '}
                    <br />
                    <span className='fs-3 fw-bold'>
                      {' '}
                      {i18n.language === 'en'
                        ? preEco.early_price.en
                        : preEco.early_price.es}{' '}
                    </span>{' '}
                    <br />
                    {i18n.language === 'en'
                      ? preEco.deadline.en
                  ...
                  <p className='fw-bold fs-4'>
                    {i18n.language === 'en'
                      ? preEco.includes_title.en
                      : preEco.includes_title.es}
                  </p>
