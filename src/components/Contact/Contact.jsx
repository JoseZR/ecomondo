                ...
                <Row className='py-5'>
                    ...
                    <Col>
                        <p className='text-center mt-5'>
                            ...
                            Tel. +49 511 89-0<br />
                            <a href='mailto:info@hfmexico.mx' target='_blank' rel='noreferrer'> info@hfmexico.mx </a>| 
                            <a href='https://www.hfmexico.mx' target='_blank' rel='noreferrer'> www.hfmexico.mx </a>
                        </p>
                    </Col>
                </Row>
            </Container>
