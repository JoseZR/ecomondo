        ...
        <Offcanvas.Body className='ms-auto'>
          <Nav className='align-items-center'>
            <NavDropdown title={t('menu.about_us')} renderMenuOnMount disabled>
              ...
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.about_2')}</NavDropdown.Item>
            </NavDropdown>
            <NavDropdown title={t('menu.exhibitors')} renderMenuOnMount disabled>
              ...
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_2')}</NavDropdown.Item>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_3')}</NavDropdown.Item>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_4')}</NavDropdown.Item>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_5')}</NavDropdown.Item>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_6')}</NavDropdown.Item>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.exhibitors_7')}</NavDropdown.Item>
            </NavDropdown>
            <NavDropdown title={t('menu.visitors')} renderMenuOnMount disabled>
              <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.visitors_1')}</NavDropdown.Item>
            </NavDropdown>
            <NavDropdown title={t('menu.past_events')} renderMenuOnMount disabled>
              <p className='mt-2 p-2 mb-0'>{t('menu.ecomondo2023')}</p>
                <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.ecomondo2023_1')}</NavDropdown.Item>
                <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.ecomondo2023_2')}</NavDropdown.Item>
              ...
              <p className='mt-2 p-2 mb-0'>{t('menu.ecomondo2022')}</p>
                <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.ecomondo2022_1')}</NavDropdown.Item>
                <NavDropdown.Item as={Link} to='/about-us' onClick={handleClose}>{t('menu.ecomondo2022_2')}</NavDropdown.Item>
            </NavDropdown>
