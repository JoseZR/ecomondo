              ...
              <Nav className='align-items-center'>
                ...
                >
                  <NavDropdown.Item
                    href={
                      i18n.language === 'es'
                        ? '/ecomondo/files/Factsheet-Ecomondo-Mexico-2024-ESP-61223v3.pdf'
                        : '/ecomondo/files/Factsheet-Ecomondo-Mexico-2024-ENG-61223v3.pdf'
                    }
                    target='_blank'
                    onClick={handleClose}
                  >
                  ...
                  <NavDropdown.Item
                    href='/ecomondo/files/ECO-Y-SSM-2024-V6-012425-Model.pdf'
                    target='_blank'
                    onClick={handleClose}
                  >
                    {t('menu.exhibitors_3')}
